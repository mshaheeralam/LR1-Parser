class LR1:
    ...
    def parser(self, table, string):
        ...
        if stack[-1] == 'accept':
            result = 1
            final_op.append('accept')

        return (final_stack, final_in, final_op, result)
